  ...
  return (
    <div className="min-h-[100dvh] bg-slate-950 flex flex-col items-center justify-center p-4 py-12 relative overflow-y-auto">
      ...
      <motion.div 
        ...
        className="pointer-events-none absolute -top-32 -left-32 w-96 h-96 rounded-full blur-3xl bg-accent/20" 
      />
      <motion.div 
        animate={{ scale: [1, 1.2, 1], opacity: [0.1, 0.2, 0.1] }}
        transition={{ duration: 8, repeat: Infinity, ease: "easeInOut", delay: 1 }}
        className="pointer-events-none absolute -bottom-32 -right-32 w-96 h-96 rounded-full blur-3xl bg-indigo-500" 
      />
      ...
      >
        <div className="relative w-40 h-40 md:w-48 md:h-48 flex items-center justify-center">
          ...
          <div className="w-full h-full relative rounded-full overflow-hidden border-2 border-accent/20 shadow-[0_0_30px_rgba(255,184,0,0.15)] bg-black/20">
            ...
            >
              <source src="/J4r2r3897piPf8x9FL.webm" type="video/webm" />
            </video>
          </div>
        </div>
      </motion.div>
      ...
      >
        ...
        >
          ...
          <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.3 }}>
            ...
            <p className="text-white/50 text-sm mb-8">Join RJ Developer and get started</p>
          </motion.div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5" noValidate>
            ...
            {/* Password */}
            <motion.div whileHover={{ scale: 1.01 }} whileTap={{ scale: 0.99 }} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.6 }} className="relative">
          ...
          <div className="mt-8">
            <div className="relative mb-8">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-[#0f172a] px-4 text-white/30">Or sign up with</span>
              </div>
            </div>
          ...
          <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.8 }} className="text-center text-white/50 text-sm mt-8">
